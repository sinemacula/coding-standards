...
final class BooleanMethodNameSniffTest extends AbstractSniffTestCase
{
     ...
     * non-boolean returns are accepted; the @imperative opt-out still holds
     * when an attribute (single, stacked or inline) sits between the docblock
     * and the signature. An adjective name like ready - even with a plain
     * docblock, and even when that docblock is hidden behind an attribute - is
     * flagged.
     *
     * @return void
     */
    ...
    {
        $this->assertErrorsOnLines('BooleanMethodName.inc', [87, 134]);
    }
