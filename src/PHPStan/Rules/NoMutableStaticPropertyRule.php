 ...
 *
 * Static properties are global mutable state: they cannot be `readonly`, so every
 * static property is writable from anywhere. This rule flags every static property
 * declaration. Immutable static data belongs in class constants, and shared
 * behaviour belongs in injected services rather than static state.
 *
